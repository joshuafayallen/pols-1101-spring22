...
Now we’re going to focus on voting. While we just talked about how voting is one of the less effective means of participation, it is something that all citizens are equally able to do, and it is the basis of electoral politics
---
...
.pull-right[
- Other Predictors of Voting Behavior: 
- Race 
- Religion 
- Marital Status 
- Ethnicity 
...
---
## Declining Voter Turnout since the $20^{th}$
...
???
we have sort of discussed the voting population in way that doesnt acknowledge some of the other structural issues that impact people who do want to vote but face barriers to do so. I want to leave you with this as we move to talk about campaingss and elections next week
---
