...
We generally focus on the representation plans. Where the Virginia Plan focused on proportional representation and the New Jersey Plan where each state would get the same number of delegates. Critically however they differ on how we elect our representatives. The New Jersey plan largely kept the spirit of the of the Ariticles of confederation. People would not directly elect their representatives. Whereas the Virginia Plan there was a more direct role for the people to elect their representatives 

The representation issue is highlighted because fundamentally this would shape the allocation of legislative, executive, and judicial power. In the coming century how senate seats were allocated would change. However the original plan only allowed for people to directly elect their member or the house (This was in the Virginia plan) while senators would be elected by the state legislatures.
...
???
So I showed you guys this slide without really going over it. The interesting thing aobut our version of liberal democracy is that we have conflict built into the system. The legislative branch checks the executive branch by approving executive appointments and appropriating money to presidential priorities. It can override presidential vetoes (needs 2/3's in both the house and senate)


can impeach both the president and the judicial branch. Right laws or amendments that circumvent judicial decisions. The judicial branch can declare executive actions and laws as unconstitutional 
---
...
- Unitary gonerments are better at redistributing resourse 
...
- Recruiting and equipping hte armed forces
...
- .hiro-orange[McCullough v. Maryland (1819)]
...
- .bold[Three main types of Commerce]:

  - Foreign Commerce – Trade and business that occurs between different countries or nation-states.
  - Interstate Commerce – Trade and business that occurs across borders between States. 
  - Intrastate Commerce – Trade and business that occurs between individuals within one single State. 


???
Many of the disputes between federal and state powers have come due to the Commerce Clause located in Article I, Section 8, Clause 3.  It is often used in conjunction with the Necessary and Proper Clause to expand the powers of Congress over many aspects of trade and business throughout the years. The courts have often become involved in an effort to untangle the problems that Congress has had in overreaching with the Commerce Clause. 

To understand the difference. Student 1 (in one row): Pick an item that you would like to produce and trade.  Student 2 (In same row): Do the same. Student 3 (in a different row) and Student 4( also in a different row): Also pick an item that you want to trade. Professor also picks an item to trade. I am going to establish a line between myself and you all. We are now two different nation states/countries. Each row within your nation is a different state as well. 

As a whole, each nation can trade with one another. = Foreign Commerce. 
Trade between individuals in different states or rows = Interstate Commerce. 
Trade between individuals in the same state or row = Intrastate Commerce. 
