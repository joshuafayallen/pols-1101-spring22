...
pacman::p_load("tidyverse", "patchwork", "modelsummary", "ggridges", "kableExtra","gameofthrones","viridis", "here", "lubridate", "stevemisc", "xaringanExtra", "flair", "countdown","hrbrthemes","ggthemes")
...
knitr::opts_chunk$set(fig.path="figs/", echo=FALSE, warning=FALSE, message=FALSE, fig.retina=3, fig.asp=.5, out.width='100%', 
                      fig.showtext = TRUE, comment = NULL)
