...
```{r, include = TRUE, echo= FALSE, out.width="95%", out.height="100%"}
...
ggplot(plot_data, aes(x = total, y = fct_reorder(major,total),
                                   color = major)) +
  geom_pointrange(aes(xmin = 0, xmax = total), fatten = 5) + 
  labs(x = "Total", y = NULL, title = "Majors in This Class") +
  guides(color = "none") +
...
???
As is the nature of an intro class like this the bulk of you are not political science majors.
Let us start to consider how you all will interact with government in your professional lives. Get in groups of like 3 or 4 and start brainstorming ways in which the government has a hand in these areas. Then think of ways that you interacted with the government today.
...
## Activity Time 
```{r, echo=FALSE}
countdown::countdown(minutes = 2, play_sound = TRUE)
```
...
force if and only if the state delegates them that authority. The book also makes the point that highest authority aka sovereignty resides in the people. And that there is an inherent tension between the government and the people in this arrangement 
---
