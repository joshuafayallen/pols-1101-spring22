...
```{r, include = TRUE, echo= FALSE, out.height= "100%"}
...
???
As is the nature of an intro class like this the bulk of you are not political science majors. Let us start to consider how you all will interact with government in your professional lives. Get in groups of like 3 or 4 and start brainstorming ways in which the government has a hand in these areas. Then think of ways that you interacted with the government today.
